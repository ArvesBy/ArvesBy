...
banner() {
    ...
    if ! [ -x "$(command -v toilet)" ]; then
        echo -e "\e[4;34m This Bomber Was Created By \e[1;Arves \e[0m"
    else
        echo -e "\e[1;34mCreated By \e[1;34m"
        toilet -f mono12 -F border Arves
    fi
    echo -e "\e[1;34m For Any Queries Join Me!!!\e[0m"
    echo -e "\e[1;32m           Telegram: https://t.me/ \e[0m"
    echo -e "\e[4;32m   Website: http://byarves.rf.gd \e[0m"
    echo " "
...
do
    ...
    echo "Press 2 To  Start --phone Bomber "
