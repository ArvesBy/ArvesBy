<h1 align="center">
  <br>
  <a href="https://github.com/arvesby /TBomb"><img src="https://i.ibb.co/F4HBKqm/TBomb.png" alt="TBomb"></a>
  <br>
  TBomb v2.1b
  <br>
</h1>
...
git clone https://github.com/By Arves /TBomb.git
cd TBomb
./TBomb.sh
```
...
**A:** There is no official website/app yet.The only official releases of TBomb are published in [Github](https://github.com/By Arves /TBomb) and [PyPi](https://pypi.org/project/tbomb)
##
